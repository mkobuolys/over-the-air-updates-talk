...
Future<String> assetImageCatalogJson() async {
  String result = await rootBundle.loadString('packages/travel_app/$assetImageCatalogJsonFile');
  return result = result.replaceAll('"image_file_name": "', '"image_file_name": "$assetImageCatalogPath/');
}
