...
class A2uiSchemas {
  ...
  static Schema stringReference({String? description, List<String>? enumValues}) => S.object(
    description: description,
    properties: {
      'path': S.string(description: 'A relative or absolute path in the data model.', enumValues: enumValues),
  ...
  /// component by its ID.
  static Schema componentReference({String? description}) => S.string(description: description);
  ...
  static Schema surfaceDeletionSchema() => S.object(properties: {surfaceIdKey: S.string()}, required: [surfaceIdKey]);
        ...
        items: S.object(
          ...
          properties: {
            ...
            'component': S.object(
              ...
              properties: {
                for (final entry
                    in ((catalog.definition as ObjectSchema).properties!['components']! as ObjectSchema)
                        .properties!
                        .entries)
