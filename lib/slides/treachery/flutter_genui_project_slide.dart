...
class FlutterGenuiProjectSlide extends FlutterDeckSlideWidget {
  const FlutterGenuiProjectSlide()
    : super(
        configuration: const FlutterDeckSlideConfiguration(
          ...
          header: FlutterDeckHeaderConfiguration(title: 'Generative UI SDK for Flutter (flutter_genui)'),
        ),
      );
  ...
  Widget build(BuildContext context) {
    return FlutterDeckImageSlideTheme(
      data: FlutterDeckImageSlideThemeData(labelTextStyle: context.flutterDeckTheme.textTheme.title),
